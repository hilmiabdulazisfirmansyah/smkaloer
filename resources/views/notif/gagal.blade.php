@if(session('gagal'))
<!--Modal: modalPush-->
<div id="notif-gagal" class="modal fade" id="modalPush" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
aria-hidden="true">
<div class="modal-dialog modal-notify modal-info" role="document">
	<!--Content-->
	<div class="modal-content text-center bg-dark">
		<!--Header-->
		<div class="modal-header d-flex justify-content-center" style="border-bottom: none;">
